 ...
 */
public class PersonalRecordsAdapter extends RecyclerView.Adapter<PersonalRecordsViewHolder> implements ItemTouchHelperAdapter {
    ...
    public void onItemDismiss(int position) {
        personalRecordsRows.remove(position);
